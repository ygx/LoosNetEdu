...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','500','height','600','src','Camara','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','Camara' ); //end AC code
  ...
  <div id="sidebar2" style="right: -1px;">
    <h3>
        使用帮助&nbsp;</h3>
    <p>
        <em>录制视频</em><br />
        在姓名栏里输入你要保存的文件名（便于日后检索、共享和播放），在信息栏里输入密码，点击录制按钮即可。录制完毕后点击停止按钮。该视频就成功地保存到服务器上了，你可以随时在姓名栏里输入文件名进行观看，也可通过告诉别人文件名进行共享交流。</p>
    <p>
        <em>聊天室<br />
        </em>输入姓名和要发送的内容，点击发送即可参与聊天，同时在线的用户都可以参与其中，这是基于FMS多线程技术的小型聊天室。</p>
    <!-- end #sidebar1 -->
  </div>
  <h1>&nbsp; </h1>
  <!-- end #mainContent --></div>
  <div id="sidebar1">
    ...
    <p>注：在信息栏里输入&quot;天王盖地虎&quot;才可以使用录制功能。<br />
      FMS服务器连接地址为：rtmp://192.168<br />
      .1.3/smallchat</p>
    <!-- end #sidebar1 -->
  </div>
  <!-- end #container -->
